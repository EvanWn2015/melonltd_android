...
//    public final static String DOMAIN = "https://ap.melonltd.com.tw";
    ...
    // common
    public final static String APP_INTRO_BULLETIN = DOMAIN + "/common/app/intro/bulletin"; // TODO
    public final static String STORE_CATEGORY_LIST = DOMAIN + "/common/store/category/list";
    public final static String STORE_AREA_LIST = DOMAIN + "/common/store/area/list"; // TODO
    ...
    // seller
    public final static String SELLER_SORT_FOOD = DOMAIN + "/seller/food/sort"; // TODO
    public final static String SELLER_SORT_CATEGORY = DOMAIN + "/seller/category/sort"; // TODO

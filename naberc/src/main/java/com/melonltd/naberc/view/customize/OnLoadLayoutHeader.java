...
public class OnLoadLayoutHeader extends PtrClassicDefaultHeader {
    ...
    public OnLoadLayoutHeader(Context context) {
        super(context);
    }

    public OnLoadLayoutHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OnLoadLayoutHeader(Context context, AttributeSet attrs, int defStyle) {
